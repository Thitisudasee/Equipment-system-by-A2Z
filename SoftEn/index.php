                ...
                <div class="card border-primary mb-3" style="width: 50rem;">
                    <div class="card-body">
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <button class="btn btn-lg btn-outline-success" name="log">เข้าสู่ระบบ</button>
                            ...
                            <button type="button" class="btn btn-lg btn-outline-primary" onclick="location.href='LogIn/AdminLogIn.php'">ผู้ดูแลระบบ</button>
