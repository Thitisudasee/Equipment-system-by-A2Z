        ...
        <hr class="my-4"> 
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <ul class="list-unstyled">
                    ...
                    <li>1. กำหนดรหัสผ่านให้ประกอบไปด้วยตัวอักษรภาษาอังกฤษตัวเล็ก ตัวใหญ่ และตัวเลขผสมกันอย่างน้อย 8 ตัว เช่น Password: Aaaa123456</li>
                    <li>2. กรอกรหัสประจำตัวและเบอร์โทรศัพท์ต้องมีขีด (-) ทุกครั้ง เช่น UserID: xxxxxxxx-x และ Tel: xxx-xxx-xxxx</li>
                    <li>3. ชื่อและนามสกุล ต้องกรอกเป็นภาษาอังกฤษเท่านั้น เช่น Firstname: Manchester และ Surname: United</li>
                </ul>
            </div>
                ...
                <div class="card border-primary mb-3" style="width: 80rem;">
                    <div class="card-body">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    ...
                                    <input type="password" class="form-control" placeholder="กรอกรหัสผ่าน" name="psw" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,}$" required>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="กรอกชื่อจริง" name="name" pattern="(^[A-Z][a-z]+)" required>
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="custom-select" id="Dropdow_Gender"name="gender" required>
                                            <option disabled selected>ระบุเพศ</option>
                                            <optgroup label="เพศ">
                                ...
                                <div class="col-sm">
                                    ...
                                    <input type="text" class="form-control" placeholder="กรอกชื่อสกุล" name="sur" pattern="(^[A-Z][a-z]+)" required>
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="custom-select" id="Dropdown_Major" name="dept" required>
                                            <option disabled selected>ระบุสาขาวิชา</option>
                                            <optgroup label="สาขา">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="custom-select" id="Dropdown_Role" name="roles" required>
                                            <option disabled selected>ระบุตำแหน่ง</option>
                                ...
                                <div class="col-sm">
                                    ...
                                    <input type="text" class="form-control" placeholder="กรอกเบอร์โทรศัพท์" name="phone" pattern="^[0-9]\d{2}-\d{3}-\d{4}$" required>
                                    </div>
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example">
                            ...
                            <button type="button" class="btn btn-lg btn-outline-warning" onclick="location.href='../LogIn/LogIn.php'">กลับ</button>
