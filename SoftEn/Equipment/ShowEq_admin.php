...
<body>
    ...
    <div class="jumbotron">
        ...
        <h2 class="display-2">หน้าจัดการอุปกรณ์(ผู้ดูแลระบบ)</h2>
        ...
        <center>
            <div class="card border-primary mb-3" style="width: 90rem;">
                <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <button type="button" class="btn btn-outline-danger" name="del" id="del" onclick="location.href='../Func_DelQ.php?delete=<?php echo $row['eq_id'];?>'">ลบ</button>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <button class="btn btn-lg btn-outline-primary" name="reg_eq" id="reg_eq" onclick="location.href='../Equipment/InsertEquipments.php'">ลงทะเบียนอุปกรณ์</button>
