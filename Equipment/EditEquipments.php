                ...
                <div class="card border-primary mb-3" style="width: 80rem;">
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <textarea rows="3" cols="10" class="form-control" placeholder="กรอกรายระเอียด" name="detail" required ><?php echo $row["eq_detail"]?></textarea>
                                    </div>
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <button type="submit" class="btn btn-lg btn-outline-success" name="submit">ยืนยัน</button>
