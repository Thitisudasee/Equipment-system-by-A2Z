...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="../Home/teacher.php">หน้าแรก <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="../Equipment/ShowEq_tmuser.php">รายการครุภัณฑ์</a>
        </li>
        </ul>
    </div>
    ...
    <div class="jumbotron">
        ...
        <h2 class="allborder lead-8">หน้าดูรายการครุภัณฑ์สำหรับอาจารย์และบุคลากร</h2>
